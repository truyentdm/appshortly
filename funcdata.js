...
function myCheckAsin(fn,dataAMZCK,tag="tag",local="us"){
  ...
  if(checkASIN(asin,dataAMZCK)){
	  ...
	  document.getElementById("lblResult").innerHTML = `
		ASIN: ${inputTextOpen} value="${asin}" id="asinID" readonly ${inputTextEnd} <span class="tooltip"><button onclick="myCopyTexFunction('asinID','myTooltipAsin')" onmouseout="outFunc('myTooltipAsin')"><span class="tooltiptext" id="myTooltipAsin">Copy to clipboard</span>Copy</button></span><br/>
	...
	`
  	...
  	document.getElementById("lblResult").innerHTML = `ASIN: ${inputTextOpen} value="${asin}" id="asinID" readonly ${inputTextEnd} <span class="tooltip"><button onclick="myCopyTexFunction('asinID','myTooltipAsin')" onmouseout="outFunc('myTooltipAsin')"><span class="tooltiptext" id="myTooltipAsin">Copy to clipboard</span>Copy</button></span><br/>
		URL: ${inputTextOpen} value="${createUrl(asin,tag,local)}" id="urlID" style="width:79.4%" ${inputTextEnd} <span class="tooltip"><button onclick="myCopyTexFunction('urlID','myTooltipUrl')" onmouseout="outFunc('myTooltipUrl')"><span class="tooltiptext" id="myTooltipUrl">Copy to clipboard</span>Copy</button></span><br/>
