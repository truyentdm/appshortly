...
function myCheckAsin(fn,dataAMZCK,local="us"){
  ...
  if(checkASIN(asin,dataAMZCK)){
	  ...
	  document.getElementById("lblResult").innerHTML = "ASIN: " + asin + "<br/>href: " + dataAMZCK[asin]["href"] + "<br/>Current Price & More Info (US) ► " + createLink(asin,local)+"<br/>Current Price & More Info (CA) ► " + createLink(asin,local)+"<br/>Current Price & More Info (UK) ► " + createLink(asin,local);
	}else{
